...
export default class News extends Component {
    ...
    getSearchSuggestions = () => {
        ...
        if (token) {
            ...
            Axios({
                method: 'get',
                url: `${BaseURL}news/my/search_suggestions/${search}/6`,
                headers: {
                    authorization: token
                }
            }).then(result => {
    ...
    getNews = () => {
        ...
        if (token) {
            ...
            Axios({
                method: 'get',
                url: `${BaseURL}news/my/${page}/${limit}/${category}/${sortOption}/${search}`,
                headers: {
                    authorization: token
                }
            }).then(result => {
                        ...
                        <div className="col-md-10 col-sm-9 p-0">
                            <div className="card box-shadow rounded-0 m-4 p-3">
                                <div className="card-header">
                                    <h4 className="text-danger"><FontAwesomeIcon icon={faNewspaper} /> My News</h4>
