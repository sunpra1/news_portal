...
import { BaseURL, CSSColorNames } from '../utils/constant';
import Axios from 'axios';
import { PopularityThreshold } from '../utils/constant';
...
class Dashboard extends Component {
    ...
    componentDidMount = async () => {
        try {
            const dashBoardData = await Promise.all([
                ...
                Axios({
                    method: "get",
                    url: `${BaseURL}news/this_week/true/${PopularityThreshold}`
                }),
                Axios({
                    method: "get",
                    url: `${BaseURL}news/previous_week/true/${PopularityThreshold}`
                }),
                Axios({
                    method: "get",
                    url: `${BaseURL}news/this_month/true/${PopularityThreshold}`
                }),
                Axios({
                    method: "get",
                    url: `${BaseURL}news/previous_month/true/${PopularityThreshold}`
                }),
                Axios({
                    method: "get",
                ...
                Axios({
                    method: "get",
                    url: `${BaseURL}news/this_week/false/${PopularityThreshold}`
                }),
                Axios({
                    method: "get",
                    url: `${BaseURL}news/this_month/false/${PopularityThreshold}`
                }),
            ]);
    ...
    render() {
        const { categories, summary, chartLabels, thisWeekData, previousWeekData, thisMonthData, previousMonthData, popularThisWeek, popularThisMonth, isRequestComplete } = this.state;
